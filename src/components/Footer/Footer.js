    ...
    <footer className="footer mt-10">
      ...
      <article className="bg-violet-600 px-10 pb-20 pt-10 md:grid grid-cols-3 gap-10">
        <div className="">
          ...
          Empower your brand with our stunning websites and impactful online strategies. Elevate your online presence with top-notch digital marketing, SEO, and captivating visual content.
          </h1>
        </div>
