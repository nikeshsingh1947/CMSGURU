    ...
    <section className="review mt-20 container mx-auto">
      <article className="flex justify-between md:flex-row flex-col  gap-10 items-center">
        <div>
          ...
          Discover the voices of satisfaction with our customer reviews section. Hear firsthand experiences and testimonials that attest to the quality and excellence of our products and services.
          </h1>
